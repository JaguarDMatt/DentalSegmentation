%Segmentacion como Clasificacion pixel a pixel de 8 categorias


[ imtest,imtrain1,imtrain2,anottest, anottrain1,anottrain2,ttest,ttrain1,ttrain2] = ChargeImagesWR( );

%% Extraigo informacion de las 7 classes
